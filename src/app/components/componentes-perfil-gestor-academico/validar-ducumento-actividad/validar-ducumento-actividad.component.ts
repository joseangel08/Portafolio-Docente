...
@Component({
  selector: 'app-validar-ducumento-actividad',
  templateUrl: './validar-ducumento-actividad.component.html',
  styleUrls: ['./validar-ducumento-actividad.component.css']
})
export class ValidarDucumentoActividadComponent implements OnInit {
