...
@Component({
  selector: 'app-modal-validar-doc',
  templateUrl: './modal-validar-doc.component.html',
  styleUrls: ['../modal-crear-usuario/modal-crear-usuario.component.css']
})
export class ModalValidarDocComponent implements OnInit {
  ...
  validarDocAct(documento){
    ...
    swalWithBootstrapButtons.fire({
      ...
      if (result.value) {
        this.servicio.validarDocumentoGeneral(documento.id, documento.observacion).subscribe(
          data=>{
